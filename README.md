...
2. Optional: Compile the program (gcc - gnu compiler collection nessecary or use the pre-compiled AutoMuteApp version in this repository if your do not want to compile and just start with it):
